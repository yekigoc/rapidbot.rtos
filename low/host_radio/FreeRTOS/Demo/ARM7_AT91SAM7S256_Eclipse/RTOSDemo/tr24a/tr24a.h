...
#define FIFOFLG_PIN (1<<17)
#define PKTFLG_PIN (1<<16)
...
#define NPCS_PIO {NPCS_PIN, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_OUTPUT_1, PIO_PULLUP}
#define SPCK_PIO {SPCK_PIN, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_PERIPH_A, PIO_DEFAULT}
#define FIFOFLG_PIO {FIFOFLG_PIN, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_INPUT, PIO_PULLUP}
#define PKTFLG_PIO {PKTFLG_PIN, AT91C_BASE_PIOA, AT91C_ID_PIOA, PIO_INPUT, PIO_PULLUP}
